...
//http://fbs179g:3000/api/convert?image=1010383523.jpg&upload=false
...
// http://fbs179g:3000/api/check?image=1010383523.jpg&res=104Wx104H
 ...
 router.get("/api/check", (req, res, next) => {
  ...
  fs.readFile(filename , function (err, content) {
    if (err) {
        res.writeHead(200, {'Content-type':'text/html'})
        console.log(err);
        res.end("No such image Request Sample   http://fbs179g:3000/api/check?image=1010383523.jpg&res=104Wx104H ");    
    } else {
        //specify the content type in the response will be an image
